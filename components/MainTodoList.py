...
class MainTodoList(ListView):
    ...
    - Keeps tasks sorted by importance (CRITICAL -> HIGH -> MEDIUM -> LOW -> NEGLIGIBLE)
    - Preserves the currently highlighted selection by task id when the list updates / reorders
    """
